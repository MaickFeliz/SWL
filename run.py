...
if __name__ == '__main__':
    with app.app_context():
        ...
        initial_items = [
            ...
            {'name': 'VideoBeam', 'total': 10, 'category': 'instructor'},
            {'name': 'Cable HDMI', 'total': 20, 'category': 'instructor'},
            {'name': 'Televisor', 'total': 5, 'category': 'instructor'},
            {'name': 'Regleta/Extension', 'total': 15, 'category': 'instructor'},
            # AGREGAMOS ESTO:
            {'name': 'Kit LEGO Education', 'total': 8, 'category': 'instructor'} 
        ]
